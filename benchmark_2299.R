...
#sub$sales <- trend_sales(sub$sales, dept, dt, 90, 0.98) did not work
#sub$sales <- trend_sales(sub$sales, dept, dt, 81, 0.98) did not work
sub$sales <- trend_sales(sub$sales, dept, dt, 82, 1.02) # 4.46 improvement
# sub$sales <- trend_sales(sub$sales, dept, dt, 18, 1.09) did not work
# sub$sales <- trend_sales(sub$sales, dept, dt, 91, 1.03) did not work
