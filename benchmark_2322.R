...
sub$sales <- trend_sales(sub$sales, dept, dt, 95, 0.93) # 5.4  improvement
...
######################################################################
# THE REMAINING ADJUSTMENTS IMPACT ~ -20 ON LB
# 
...
sub$MarkDown1 <- Hmisc::impute(sub$MarkDown1, 0)
...
# 1 point LB improvement
sub$sales <- with(sub, sales + ifelse(MarkDown1 > 9990 & dept == "40" ,2073, 0))
sub$sales <- with(sub, sales + ifelse(MarkDown1 > 6340 & MarkDown1 <= 9990 & dept == "40" , 1897, 0))
sub$sales <- with(sub, sales + ifelse(MarkDown1 > 3530 & MarkDown1 <= 6340 & dept == "40" , 848, 0))
sub$sales <- with(sub, sales + ifelse(MarkDown1 > 859  & MarkDown1 <= 3530 & dept == "40" , 1058, 0))
sub$sales <- with(sub, sales + ifelse(MarkDown1 <= 859 & dept == "40" , 514, 0))


# sub$sales <- with(sub, sales + ifelse(MarkDown1 > 4970 & dept == "2" , 1742, 0))
# sub$sales <- with(sub, sales + ifelse(MarkDown1 <= 4970 & dept == "2" , 815, 0))
