...
# I THINK TREND CALCULATION IS OFF BY A MONTH
...
# (WOULD IT BE BETTER JUST TO BLEND)
...
# DROP_DATES <- as.character(ymd("2012-11-02") + weeks(1:38))

DROP_DATES <- c("2012-11-02", "2012-11-09", "2012-11-16", "2012-12-07", 
                "2012-12-14", "2012-12-21", "2012-12-28", "2013-01-04", 
                "2013-01-11", "2013-01-18", "2013-01-25", "2013-02-01", 
                "2013-02-08", "2013-02-15", "2013-02-22", "2013-03-01", 
                "2013-03-08", "2013-03-15", "2013-03-22", "2013-03-29", 
                "2013-04-12", "2013-04-19", "2013-04-26", "2013-05-03", 
                "2013-05-10", "2013-05-17", "2013-05-24", "2013-05-31", 
                "2013-06-07", "2013-06-14", "2013-06-21", "2013-06-28", 
...
sub$sales <- trend_sales(sub$sales, dept, dt, 6, 0.79) # 1.02 improvement (has prospective)
...
# Include prospective trend for dept 6
#sub$sales <- ifelse(dept == 6, 0.79 * sub$sales, sub$sales)
