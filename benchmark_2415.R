# Kaggle Walmart recruiting competition
# 2014-02-20 to 2014-05-05
...
trend_sales <- function(v_sales, v_id, v_dt, id_num, trend_fctr) {
  ...
  # components corresponding to store_num
...
# Do the first and last weeks of the period need to be blended?
